(() => {
  ...
  async function boot(){
    ...
    addStyle("./scenic-map-v71.css?v=71","scenicMapStyleV71");
    ...
    window.dispatchEvent(new CustomEvent("onsen-scenic-v71-ready",{detail:{build:BUILD,progress:window.OnsenScenicRuntime?.progress?.()||null}}));return true;
  }
