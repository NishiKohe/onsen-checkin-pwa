(() => {
  const version = "v72.2";
  const preferredWorker = "./sw.js?v=72.2";
  ...
  function ensureBridges() {
    ...
    addBridge({ globalName: "OnsenScenicV71Bridge", id: "scenicV71BridgeScript", src: "./scenic-v70-bridge.js?v=72.2", label: "v72.2 scenic bridge" });
  ...
  async function registerPreferredWorker() {
    ...
    try {
      ...
      console.warn("v72.2 service worker update check skipped", err);
      return null;
    }
  }
  ...
  function patchServiceWorkerRegister() {
    ...
    if (sw.__onsenV722RegisterPatched) return;
    try {
      ...
      Object.defineProperty(sw, "__onsenV722RegisterPatched", { value: true, configurable: false });
    } catch (error) {
      console.warn("v72.2 service worker register patch skipped", error);
    }
  }
