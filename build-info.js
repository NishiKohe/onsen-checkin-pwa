(() => {
  const version = "v70.10";
  const preferredWorker = "./sw.js?v=70.10";
  ...
  async function registerPreferredWorker() {
    ...
    try {
      ...
      console.warn("v70.10 service worker update check skipped", err);
      return null;
    }
  }
  ...
  function patchServiceWorkerRegister() {
    ...
    if (sw.__onsenV7010RegisterPatched) return;
    try {
      ...
      Object.defineProperty(sw, "__onsenV7010RegisterPatched", { value: true, configurable: false });
    } catch (error) {
      console.warn("v70.10 service worker register patch skipped", error);
    }
  }
