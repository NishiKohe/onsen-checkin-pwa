(() => {
  const version = "v72.4";
  const preferredWorker = "./sw.js?v=72.4";
  ...
  function ensureBridges() {
    ...
    addBridge({ globalName: "OnsenScenicV71Bridge", id: "scenicV71BridgeScript", src: "./scenic-v70-bridge.js?v=72.4", label: "v72.4 scenic bridge" });
  ...
  async function registerPreferredWorker() {
    ...
    try {
      ...
      console.warn("v72.4 service worker update check skipped", err);
      return null;
    }
  }
  ...
  function patchServiceWorkerRegister() {
    ...
    if (sw.__onsenV724RegisterPatched) return;
    try {
      ...
      Object.defineProperty(sw, "__onsenV724RegisterPatched", { value: true, configurable: false });
    } catch (error) {
      console.warn("v72.4 service worker register patch skipped", error);
    }
  }
