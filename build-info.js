(() => {
  ...
  function ensureBridges() {
    ...
    addBridge({ globalName: "OnsenDomainAchievements", id: "achievementDomainV702Script", src: "./achievement-domain-v702.js?v=70.6", label: "v70.6 domain achievements" });
    addBridge({ globalName: "OnsenScenicV70Bridge", id: "scenicV70BridgeScript", src: "./scenic-v70-bridge.js?v=70.6", label: "v70.6 scenic bridge" });
  }
