(() => {
  const version = "v70.9";
  const preferredWorker = "./sw.js?v=70.9";
  ...
  function ensureBridges() {
    ...
    addBridge({ globalName: "OnsenScenicV70Bridge", id: "scenicV70BridgeScript", src: "./scenic-v70-bridge.js?v=70.9", label: "v70.9 scenic bridge" });
  }
  ...
  async function registerPreferredWorker() {
    ...
    try {
      ...
      console.warn("v70.9 service worker update check skipped", err);
      return null;
    }
  }
  ...
  function patchServiceWorkerRegister() {
    ...
    if (sw.__onsenV709RegisterPatched) return;
    try {
      ...
      Object.defineProperty(sw, "__onsenV709RegisterPatched", { value: true, configurable: false });
    } catch (error) {
      console.warn("v70.9 service worker register patch skipped", error);
    }
  }
