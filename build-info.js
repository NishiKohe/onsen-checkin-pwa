(() => {
  const version = "v70.8";
  const preferredWorker = "./sw.js?v=70.8";
  ...
  function ensureBridges() {
    ...
    addBridge({ globalName: "OnsenScenicV70Bridge", id: "scenicV70BridgeScript", src: "./scenic-v70-bridge.js?v=70.8", label: "v70.8 scenic bridge" });
  }
  ...
  async function registerPreferredWorker() {
    ...
    try {
      ...
      console.warn("v70.8 service worker update check skipped", err);
      return null;
    }
  }
  ...
  function patchServiceWorkerRegister() {
    ...
    if (sw.__onsenV708RegisterPatched) return;
    try {
      ...
      Object.defineProperty(sw, "__onsenV708RegisterPatched", { value: true, configurable: false });
    } catch (error) {
      console.warn("v70.8 service worker register patch skipped", error);
    }
  }
