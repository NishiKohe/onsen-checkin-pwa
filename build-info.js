(() => {
  const version = "v70.1";
  const preferredWorker = "./sw.js?v=70.1";
  ...
  function ensureBridges() {
    ...
    addBridge({ globalName: "OnsenScenicV70Bridge", id: "scenicV70BridgeScript", src: "./scenic-v70-bridge.js?v=70.1", label: "v70.1 scenic bridge" });
  }
  ...
  async function registerPreferredWorker() {
    ...
    try {
      ...
      console.warn("v70.1 service worker update check skipped", err);
      return null;
    }
  }
  ...
  function patchServiceWorkerRegister() {
    ...
    if (sw.__onsenV701RegisterPatched) return;
    try {
      ...
      Object.defineProperty(sw, "__onsenV701RegisterPatched", { value: true, configurable: false });
    } catch (error) {
      console.warn("v70.1 service worker register patch skipped", error);
    }
  }
