(() => {
  const version = "v72.3";
  const preferredWorker = "./sw.js?v=72.3";
  ...
  function ensureBridges() {
    ...
    addBridge({ globalName: "OnsenScenicV71Bridge", id: "scenicV71BridgeScript", src: "./scenic-v70-bridge.js?v=72.3", label: "v72.3 scenic bridge" });
  ...
  async function registerPreferredWorker() {
    ...
    try {
      ...
      console.warn("v72.3 service worker update check skipped", err);
      return null;
    }
  }
  ...
  function patchServiceWorkerRegister() {
    ...
    if (sw.__onsenV723RegisterPatched) return;
    try {
      ...
      Object.defineProperty(sw, "__onsenV723RegisterPatched", { value: true, configurable: false });
    } catch (error) {
      console.warn("v72.3 service worker register patch skipped", error);
    }
  }
