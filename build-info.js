(() => {
  const version = "v70.2";
  const preferredWorker = "./sw.js?v=70.2";
  ...
  async function registerPreferredWorker() {
    ...
    try {
      ...
      console.warn("v70.2 service worker update check skipped", err);
      return null;
    }
  }
  ...
  function patchServiceWorkerRegister() {
    ...
    if (sw.__onsenV702RegisterPatched) return;
    try {
      ...
      Object.defineProperty(sw, "__onsenV702RegisterPatched", { value: true, configurable: false });
    } catch (error) {
      console.warn("v70.2 service worker register patch skipped", error);
    }
  }
