const CACHE_NAME = "onsen-checkin-v70.9";
const CORE_ASSETS = [
  ...
  "./data/castles-zoku100-v68.csv", "./data/scenic-national-v70.json", "./data/scenic-shards-v70.json", "./data/scenic-ordinary-bootstrap-v70.json", "./data/fish-catalog-v61.json",
