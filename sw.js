const CACHE_NAME = "onsen-checkin-v72.6";
const CORE_ASSETS = [
  ...
  "./data/scenic-official-v71.json", "./data/scenic-checkin-zones-v71.json", "./data/scenic-checkin-audit-v72.json", "./data/scenic-checkin-multizone-v724.json", "./data/fish-catalog-v61.json",
